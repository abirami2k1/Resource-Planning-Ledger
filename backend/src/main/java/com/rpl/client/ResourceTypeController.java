...
public class ResourceTypeController {
    ...
    @GetMapping public List<ResourceType> list() { 
        return manager.list(); 
    }

    @PostMapping public ResourceType create(@RequestBody ResourceType resourceType) { 
        return manager.create(resourceType); 
    }
